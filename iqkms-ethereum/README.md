# `iqkms-ethereum`: Ethereum signing service
...
gRPC service for computing Ethereum signatures using keys stored in *iqkms*.
...
[build-image]: https://github.com/iqlusioninc/iqkms/actions/workflows/iqkms-ethereum.yml/badge.svg
[build-link]: https://github.com/iqlusioninc/iqkms/actions/workflows/iqkms-ethereum.yml
