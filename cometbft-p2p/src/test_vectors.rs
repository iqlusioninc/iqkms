...
//!
//! All of these were generated by `cometbft-p2p` as the reference implementation. The crate itself
//! has been extensively integration tested in production against both CometBFT (including v1.0) and
//! legacy versions of Tendermint.
